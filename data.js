const STORAGE_KEY    = 'venice-beach-quest-v2';
const GOALS_KEY      = 'venice-beach-quest-goals-v2';
const COMPLETION_KEY = 'venice-beach-quest-complete-v2';

const DEFAULT_GOAL_STEPS = 20000;
const ROUTE_TOTAL_MILES  = 10.0;

const ROUTE_MILES  = [0, 0.4, 1.1, 2.0, 3.0, 6.4, 10.0];
const ROUTE_POINTS = [
  [36,  138],
  [165, 106],
  [318,  76],
...
const STOPS = [
  {
    id: 1, miles: 0.4,
    name: 'Venice Sign', short: 'Sign', emoji: '✦',
  ...
  {
    id: 2, miles: 1.1,
    name: 'Muscle Beach', short: 'Muscle Beach', emoji: '💪',
  ...
  {
    id: 3, miles: 2.0,
    name: 'Venice Skatepark', short: 'Skatepark', emoji: '🛹',
  ...
  {
    id: 4, miles: 3.0,
    name: 'Venice Art Walls', short: 'Art Walls', emoji: '🎨',
  ...
  {
    id: 5, miles: 6.4,
    name: 'Venice Boardwalk', short: 'Boardwalk', emoji: '☼',
  ...
  {
    id: 6, miles: 10.0,
    name: 'Venice Pier', short: 'Pier', emoji: '🎣',
